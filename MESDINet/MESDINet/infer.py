...
def main():
    net = MESDINet(backbone_path).cuda(device_ids[0])

    net.load_state_dict(torch.load('MESDINet.pth'))
    print('Load {} succeed!'.format('MESDINet.pth'))
